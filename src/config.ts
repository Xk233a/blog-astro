...
export const siteConfig: SiteConfig = {
	title: "知行手稿|Xk233",
	subtitle: "知于思考，行于代码",
	siteURL: "https://www.1fu.top/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2023-12-01", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Xk233a/blog-astro",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/582132332",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/xk233a",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const profileConfig: ProfileConfig = {
	avatar: "https://avatars.githubusercontent.com/u/125188926?v=4", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "Xk233",
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		...
		link: "https://github.com/Xk233a/blog-astro", // 关于链接
	},
};
